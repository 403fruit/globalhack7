...
def seed_categories():
    ...
    db.session.add_all([
        ...
        get_or_create({'name': "Dining Table", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),
        get_or_create({'name': "Table", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),
        get_or_create({'name': "Refrigerator", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),
        get_or_create({'name': "Microwave", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),
        get_or_create({'name': "Stove or Oven", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),
        get_or_create({'name': "Clothes Washer or Dryer", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': None}),

        get_or_create({'name': "Lawn Mowing", 'parent': jobs}, {'fontawesome_icon': None, 'linecon_icon': None}),
