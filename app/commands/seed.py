...
def seed_categories():
    ...
    db.session.add_all([
        ...
        get_or_create({'name': "Dining Table", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': 'stack'}),
        get_or_create({'name': "Table", 'parent': furnishings}, {'fontawesome_icon': None, 'linecon_icon': 'stack'}),
        ...
        get_or_create({'name': "Lawn Mowing", 'parent': jobs}, {'fontawesome_icon': None, 'linecon_icon': 'cloud'}),
